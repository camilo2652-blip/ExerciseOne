...
QuadratricEquationsSolution QuadraticEquation(double a, double b, double c)
{
    return new QuadratricEquationsSolution
    {
...
public class QuadratricEquationsSolution
{
