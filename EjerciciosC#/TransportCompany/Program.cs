...
do
{
    ...
    var passangers = ConsoleExtension.GetInt("Número de pasajeros tota...........................: ");
    var packages10 = ConsoleExtension.GetInt("Número de encomiendas menos de 10..................: ");
    var packages10_20 = ConsoleExtension.GetInt("Número de encominedas entre 10g y menos de 20Kg....: ");
    var packages20 = ConsoleExtension.GetInt("Número de encominedas de más de 20Kg...............: ");
    ...
    var fueValue = GetFueValue(route, trips, passangers, packages10, packages10_20, packages20);
    var deductions = valueHelper + valueAssurrace + fueValue;
    ...
    Console.WriteLine($"Pago Combustible...................................: {fueValue,20:C2}");
    Console.WriteLine("                                                     --------------------");
    Console.WriteLine($"TOTAL DEDUCIONES...................................: {deductions,20:C2}");
    Console.WriteLine("                                                     ====================");
...
decimal GetFueValue(string? route, int trips, int passangers, int packages10, int packages10_20, int packages20)
{
    ...
    var weitgh = passangers * 60 + packages10 * 10 + packages10_20 * 15 + packages10_20 * 20;
